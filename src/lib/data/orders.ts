...
// payment 한글 → PaymentType (카드→CARD, 계좌이체→BANK, 간편결제→KAKAOPAY 대표값, D-6).
...
export const ORDERS: OrderListRow[] = [
  ...
  { orderNo: 'O-260520-0417', orderDate: '2026-05-20 10:54', customerName: '임채린', itemCount: 2, finalAmount: 326000, paymentType: 'KAKAOPAY', orderStatus: 'PAID', paymentStatus: 'PAID', shippingStatus: 'READY' },
  ...
  { orderNo: 'O-260519-0417', orderDate: '2026-05-19 20:41', customerName: '최민지', itemCount: 2, finalAmount: 246000, paymentType: 'KAKAOPAY', orderStatus: 'PAID', paymentStatus: 'PAID', shippingStatus: 'IN_TRANSIT' },
  ...
  { orderNo: 'O-260519-0412', orderDate: '2026-05-19 11:39', customerName: '한지원', itemCount: 2, finalAmount: 196000, paymentType: 'KAKAOPAY', orderStatus: 'PAID', paymentStatus: 'PAID', shippingStatus: 'DELIVERED' },
